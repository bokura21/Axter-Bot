...
const SUPPORT_SERVER_URL = "https://discord.gg/WwMyNFMbfD";
export default {
  ...
  async execute(interaction) {
    try {
      ...
      await InteractionHelper.safeReply(interaction, {
        embeds: [
          createEmbed({ title: "Need Help?", description: "Join our official support server for assistance, report bugs, suggest new features or get to know about Axter." }),
        ],
